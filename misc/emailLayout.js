const emailLook = (secretToken)=>{
    ...
    <div class="main-div">
        ...
        <p class="footer sharedProp paragraphs">Miłego dnia!</p>
    </div>
`;
    return html
...
const forgotPasswordLook = (secretToken='', header='',paragrafFirst='',paragrafTh='', link='', footer='')=>{
    const html =   `
    <head>
    <style type="text/css">
    .main-div{
...
module.exports = forgotPasswordLook;